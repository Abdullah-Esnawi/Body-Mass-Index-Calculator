...
// constant colour give to every Box Layout
const kinactiveCardColor =
    Colors.teal; // gesture color when on Tap function works
...
const kresultTextStyle = TextStyle(
    color: Color(0xFF91FFC3), fontSize: 30.0, fontWeight: FontWeight.bold);
